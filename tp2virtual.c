...
int main(int argc, char *argv[]){
	...
	if(strcmp(alg, "lru") && strcmp(alg, "fifo") && strcmp(alg,"random") && strcmp(alg, "nru")){
		printf("ERRO: O algoritmo deve ser lru, fifo, random, nru ou segundachance.");
		return 0;	
	}
